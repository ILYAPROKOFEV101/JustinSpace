...
namespace Tools.Properties.MainTools
{
    public abstract class Stages
    {
        ...
        protected void PrintParameters()
        {
            ...
            Console.WriteLine("X = " + Math.Round(movementXValues[movementXValues.Count - 1]) + " м");
            Console.WriteLine("Y = " + Math.Round(movementYValues[movementYValues.Count - 1]) + " м");

            var vx = speedXValues[speedXValues.Count - 1];
            var vy = speedYValues[speedYValues.Count - 1];
            ...
            var ax = accelerationXValues[accelerationXValues.Count - 1];
            var ay = accelerationYValues[accelerationYValues.Count - 1];
